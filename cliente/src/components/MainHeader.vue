    ...
    <div class="content-header">
        ...
        <header>
            ...
            <nav id="main-navbar">
                ...
                <ul>
                    <li><router-link to="/"><span class="icon-home"></span>Home</router-link></li>
                </ul>
            </nav>
            <!-- MENU DE USUARIO - SESSIÓN -->
            <div class="menu-visible">
                <nav>
                    <ul>
                        <li><a href="#" class="log-in" id="OpenLogin">Iniciar Sesión</a></li>
                        <li>
...
.content-header{
	...
	z-index: 10000;
    width: 100%;
    box-shadow: 1px 1px 10px rgb(121 121 121);
    -webkit-box-shadow: 1px 1px 10px rgb(121 121 121);
}
/* LOGO */
.logo-nav {
	width: 220px;
...
.menu-visible nav ul li a.log-in{
    background-color: #fff;
}
.menu-visible nav ul li a.log-in:hover{
    color: #1c1c1c;
}
